...
<head>
  ...
  <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy fast meeals.">
...
<body>
  ...
  <section class="section-cities" id="cities">
    ...
    <div class="row js--wp-3">
      <div class="col span-1-of-4 box">
        <img src="/omniFood/resources/img/lisbon-3.jpg" alt="Lisbon">   
        <h3>Lisbon</h3>     
      ...
      <div class="col span-1-of-4 box">
          <img src="/omniFood/resources/img/san-francisco.jpg" alt="San Francisco">   
          <h3>San Francisco</h3>     
          <div class="city-feature">
              <i class="ion-ios-person icon-small"></i>
              3700+ happy eaters
        ...
        <div class="col span-1-of-4 box">
            <img src="/omniFood/resources/img/berlin.jpg" alt="Berlin">   
            <h3>Berlin</h3>     
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                2300+ happy eaters
          ...
          <div class="col span-1-of-4 box">
              <img src="/omniFood/resources/img/london.jpg" alt="London">   
              <h3>London</h3>     
              <div class="city-feature">
                  <i class="ion-ios-person icon-small"></i>
                  1200+ happy eaters
  ...
  <section class="section-plans js--section-plans" id="plans">
    ...
    <div class="col span-1-of-3">
        <div class="plan-box">
          <div>
            <h3>Pro</h3>
            <p class="plan-price">$14<span>/ month </span></p>
